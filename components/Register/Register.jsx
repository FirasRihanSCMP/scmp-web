        ...
        <div className={styles.App}>
            {success ? (
                ...
                <section className={[styles.section]}>
                    <p ref={errRef} className={[errMsg ? styles.errmsg : styles.offscreen, styles.p]} aria-live="assertive">{errMsg}</p>
                    <h1>Register</h1>
                    <form className={styles.form} onSubmit={handleSubmit}>
                        ...
                        <p id="uidnote" className={userFocus && user && !validName ? styles.instructions : styles.offscreen}>
                            <FontAwesomeIcon className={styles.iconSize} icon={faInfoCircle} />
