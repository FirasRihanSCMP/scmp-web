...
const options={
  ...
  return (<div className={styles.uploaderRoot} >

    <form method="post" action="#" id="#" className={styles.eventForm} onSubmit={onSubmitFile}>
    
  
      <Row><Col><div className={`${styles.formGroup} ${styles.files}`}>
        ...
        <br />
        <div className={`${styles.formGroup} ${styles.files}`}>
 ...
 <div className={styles.circularProgressDiv}>      <CircularProgressbar
 value={percentage}
 maxValue={100}
 text={`${percentage}%`}
 strokeWidth={5}
